              ...
              <div className="w-full 800px:w-[50%]">
                <div className="w-full 800px:w-[80%] pt-5">
                  ...
                  <div className="flex items-center pt-8">
                    <img src={data.shop.shop_avatar.url} alt="" className="w-[70px] h-[70px] rounded-full mr-2"/>
                    <div className="">
                      <h3 className={`${styles.shop_name} pb-1 pt-1 text-[18px]`}>{data.shop.name}</h3>
                      <h5 className="pb-3 text-[16px]">({data.shop.ratings}) ratings</h5>
                    </div>
                    <div className={`${styles.button} bg-[#6443d1] mt-4 !rounded !h-11 ml-5` } onClick={handleMessageSubmit}>
...
const ProductDetailsInfor = () => {
  const [active, setActive] = useState(1)
    return (
      <div className="bg-[#f5f6fb] px-3 800px:px10 py-2 rounded">
        <div className="w-full flex justified-between border-b pt-10 pb-2">
